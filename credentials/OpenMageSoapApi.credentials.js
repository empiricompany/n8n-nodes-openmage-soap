...
exports.OpenMageSoapApi = void 0;
class OpenMageSoapApi {
    constructor() {
        this.name = 'openMageSoapApi';
        this.displayName = 'OpenMage SOAP API';
        this.documentationUrl = 'https://www.openmage.org/documentation/';
        this.properties = [
            {
                displayName: 'API URL',
                name: 'apiUrl',
...
exports.OpenMageSoapApi = OpenMageSoapApi;
